...
- **Telegram Bot**：通过 Telegram Bot 推送签到结果，方便用户查看签到状态。
...
### 5️⃣ 添加 Telegram Bot
1. 创建名为 `TG_CONFIG` 的 Secret。
2. 填入 Telegram Bot 的配置信息，格式为：`BotToken + ChatID`
    ```
    1234567890:ABCDEFGHIJKLMNOPQRSTUVWXYZ;123456890
    ```
